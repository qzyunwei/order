    ...
    <div id="main-content">
      ...
      <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <form action="save_shop" method="POST" accept-charset="utf-8" id="order">
              <fieldset>
                  <div class="controls">
                    <div class="control-group">
                      <label class="control-label" for="focusedInput">餐馆名称：</label>
                      <div class="controls">
                        <input class="text-input" name="shopname" id="focusedInput" type="text" value="<?php echo ($edit_order["shopname"]); ?>">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="text-input"  name="start_price" type="text" value="<?php echo ($edit_order["start_price"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"><span class="add-on">元</span>
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="text-input" name="phone" type="text" value="<?php echo ($edit_order["phone"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="text-input" name="address" type="text" value="<?php echo ($edit_order["address"]); ?>">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">营业时间：</label>
                      <div class="controls">
                        <input class="text-input" name="business_hours" type="text" value="<?php echo ($edit_order["business_hours"]); ?>">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">备注与说明：</label>
                      <div class="controls">
                        <input class="text-input" name="info" type="text" value="<?php echo ($edit_order["info"]); ?>">
                      </div>
                    </div>
