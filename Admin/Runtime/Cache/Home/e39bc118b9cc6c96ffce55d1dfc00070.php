              ...
              <fieldset>
                  <div class="controls">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <p class="text-input" name="shopname" id="focusedInput" type="text" value="sdfghjk" style="">******<a href="/order/admin.php/Home/ChangeAdmin/save_password" style="margin-left:50px"> 修改密码</a>    </p>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="text-input" name="name" type="text" value="<?php echo ($user_info["name"]); ?>">
                      </div>
                    </div>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input class="text-input" name="info" type="text" value="<?php echo ($user_info["info"]); ?>">
                      </div>
                    </div>
