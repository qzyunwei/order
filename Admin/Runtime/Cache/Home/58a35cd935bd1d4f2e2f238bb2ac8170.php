...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
        ...
        <div id="profile-links">
            ...
            <a href="/order/admin.php/Home/Menu/quit" title="退出">退出</a>
        </div>

        <ul id="main-nav">
            <!-- 类型为nav-top-itrm current 表示选中时的样式 -->
            <li> <a  href="#" class="nav-top-item">订单 Order</a>
              <ul>
                <li><a href="/order/admin.php/Home/OrderIndex/index">当前订单</a></li>
                <!-- <li><a href="#">获奖项目</a></li>
                <li><a href="#">开发课题</a></li> -->
              </ul>
            </li>

             <li> <a href="#" class="nav-top-item current">菜单 Menu</a>
              <ul>
                <li><a class="current"  href="#">菜单展示</a></li>
                <li><a href="#">菜单录入</a></li>
              </ul>
            </li>
  ...
  <div id="main-content">
    ...
    <!--  <ul class="shortcut-buttons-set">
     ...
     -->
     <!-- <li>
        <a class="shortcut-button" href="/order/admin.php/Home/Menu/article">
            <span>
          ...
          <table>
            ...
            <tbody>
              <?php if(is_array($menu_list)): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td></td>
                <td><?php echo ($vo["name_menu"]); ?> </td>
                <td><?php echo ($vo["price_menu"]); ?></a></td>
                <td><?php echo ($vo["res_menu"]); ?></td>
                <td>
                  <!-- 操作按钮 -->
                  <a href="#tab2" title="编辑"><img src="/order/Public/Images/admin/icons/pencil.png" alt="编辑" /></a>
            ...
            End .clear
                  ...
                  <a href="/order/admin.php/Home/Menu/delete/id/<?php echo ($vo["id"]); ?>" title="删除"><img src="/order/Public/Images/admin/icons/cross.png" alt="删除" /></a>
